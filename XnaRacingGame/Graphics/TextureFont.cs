// Project: RacingGame, File: TextureFont.cs
// Namespace: RacingGame.Graphics, Class: TextureFont
...
namespace RacingGame.Graphics
{
	...
	class TextureFont : IDisposable
	{
		...
		{
			WriteText(x - GetTextWidth(text) / 2, y, text,
			...
			Color col)
		{
			WriteText(x, y,
				...
				col);
		} // WriteGameTime(x, y, timeMilliseconds)
		#endregion
		...
		/// </summary>
		//[Test]
		static public void TestTextureFont()
		{
			//unused: TextureFont testFont = null;
			TestGame.Start("TestTextureFont",
				null,
				/*
				delegate
				{
					testFont = new TextureFont();
				},
				 */
				delegate
				{
					TextureFont.WriteText(2, 32, "!@#$%^&*()0"+
						"123456789abcdefghijklmnopqrstuvwxyz");
					TextureFont.WriteText(2, 62,
						"ABCDEFGHIJKLMNOPQRSTUVWXYZ{}[]|<>?:;,./\\-_");
					
					//TextureFont.WriteText(2, 62, "Hi there, this is some test text.");
				});
		} // TestTextureFont()
#endif
		#endregion
