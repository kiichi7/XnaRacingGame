#if TST_DISABLED
// Project: RacingGame, File: DisposeHelper.cs
// Namespace: RacingGame.Helpers, Class: DisposeHelper
...
namespace RacingGame.Helpers
{
	...
	class DisposeHelper
	{
		...
		/// </summary>
		/// <param name="someObject">Some object</param>
		public static void Dispose(ref RacingGame.Graphics.Texture someObject)
		{
			if (someObject != null)
				someObject.Dispose();
			someObject = null;
		...
		/// </summary>
		/// <param name="someObject">Some object</param>
		public static void Dispose(ref RacingGame.Graphics.TextureFont someObject)
		{
			if (someObject != null)
				someObject.Dispose();
			someObject = null;
		...
		/// </summary>
		/// <param name="someObject">Some object</param>
		public static void Dispose(ref RacingGame.Graphics.LensFlare someObject)
		{
			if (someObject != null)
				someObject.Dispose();
			someObject = null;
