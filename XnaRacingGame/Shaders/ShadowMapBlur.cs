// Project: RacingGame, File: ShadowMapBlur.cs
// Namespace: RacingGame.Shaders, Class: ShadowMapBlur
...
namespace RacingGame.Shaders
{
	...
	public class ShadowMapBlur : ShaderEffect
	{
		...
		public void RenderShadows(BaseGame.RenderHandler renderCode)
		{
			...
			//obs: RenderToTexture.ResetRenderTarget(false);
		...
		public void RenderShadows()
		{
			...
			blurMapTexture.Resolve(false);
			//RenderToTexture.ResetRenderTarget(false);

			// Restore depth buffer because shadow mapping might be smaller
			// than the background depth buffer
			BaseGame.Device.DepthStencilBuffer = RenderToTexture.remDepthBuffer;
		...
		public void ShowShadows()
		{
			...
			// Restore back buffer as render target
			//not required: RenderToTexture.ResetRenderTarget(false);
