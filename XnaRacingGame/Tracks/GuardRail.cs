// Project: RacingGame, File: GuardRail.cs
// Namespace: RacingGame.Tracks, Class: GuardRail
// Path: C:\code\RacingGame\Tracks, Author: Abi
// Code lines: 494, Size of file: 16,15 KB
// Creation date: 30.09.2006 13:19
// Last modified: 13.10.2006 16:09
...
namespace RacingGame.Tracks
{
	...
	class GuardRail : IDisposable
	{
		...
		/// </summary>
		const float CorrectionScale = 0.0019f;//0.0015f;//0.002f;

		/// <summary>
		/// Gap between the seperate piles.
		/// </summary>
		const float HolderGap = 15.0f;//7.5f; //15;//25;//20;

		/// <summary>
		/// Guard rail rendering height (little bit above the ground).
		/// </summary>
		const float GuardRailHeight = 1.35f*1.5f*0.425f;//0.45f;//0.35f;

		/// <summary>
		/// Put guardrails a little bit on the inside of the road.
		/// </summary>
		public const float InsideRoadDistance = 0.5f;//0.225f;//0.175f;//0.15f;//0.125f;

		/// <summary>
		/// Correction vector to put holder pile at the correct position.
		/// </summary>
		static readonly Vector3 HolderPileCorrectionVector =
			//new Vector3(45f, 0, 0) * CorrectionScale;
			//new Vector3(0.125f, 0, 0);
			//new Vector3(0.175f, 0, 0);
		...
		/// </summary>
		//[Test]
		static public void TestGuardRailVertices()
		{
			GuardRail rail = null;
			TestGame.Start(
				delegate
